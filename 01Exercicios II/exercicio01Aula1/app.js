...
*/
const my3FavoriteTVShows = ['How I macht your a mother', 'Batman', 'Still']
...
console.log(`Todos os ${falsyValues.length} são falsy. Inclusive o ${falsyValues[2]}`)
...
console.log(ageSum)
console.log(`A soma entre o ${ages[0]} e o ${ages[2]} item de "ages" é menor ou igual a 92. Essa afirmação é: ${ageSum <= 92}.`)
