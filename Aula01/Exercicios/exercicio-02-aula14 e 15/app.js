...
*/
const winterMessageIndex = winterMessage.indexOf('v')
console.log(winterMessageIndex)
...
*/
const winterMessageIndexOf = winterMessage.indexOf('n')
console.log(winterMessageIndexOf)
...
- Exiba a "newName" no console;
*/
newName = `${nome[0].toLocaleUpperCase()}${nome.slice(1,
6)}${nome[7].toUpperCase()}${nome.slice(8,12)} 2`
console.log(newName)