...
*/
const foodsInfo = `Até aqui, o array \'brazilianFoods\' possui ${brazilianFoods.length} items: ${brazilianFoods[0]}, ${brazilianFoods[1]}, ${brazilianFoods[2]},`;
...
*/
const dogNamesJoin = dogNames.join(', ')
console.log(dogNamesJoin)
